...
(Frequency, array) = read('/Users/hemanthkalyan/Downloads/SE project/sample.wav') # Reading the sound file. 
...
write("New-Filtered-sample.wav", Frequency, newFilteredSignal) # Saving it to the file.